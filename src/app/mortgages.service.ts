...
export class MortgagesService {
  ...
  constructor(private http:Http) { }
    ...
    getMortgages(): Promise<Mortgage[]> {
        let url = 'http://13.75.40.10/mortgages';
    ...
    private extractData(res:Response) {
        ...
        return body.mortgages || { };
    }

    private extractOneData(res:Response) {
        let body = res.json();
       
        return body.mortgages[0] || { };
    }
  ...
  getMortgageById(id:number): Promise<Mortgage> {
        let url = 'http://13.75.40.10/mortgage/' + id;
        return this.http.get(url)
                    .toPromise()
                    .then(this.extractOneData)
                    .catch(this.handleError);
   } 
}
